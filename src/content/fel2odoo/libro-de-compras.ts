...
Fel2Odoo recibe las facturas de compra directamente de la SAT en tiempo real y las registra automáticamente en Odoo. Cada Vendor Bill se crea con todos los datos que alimentan el libro de compras: fecha, NIT del proveedor, descripción, montos, IVA y tipo de documento.

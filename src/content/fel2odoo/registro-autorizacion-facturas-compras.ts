...
Fel2Odoo conecta directamente con la SAT de Guatemala y registra las facturas de compra en Odoo de forma automática. Los datos se extraen del XML certificado y se crean los Vendor Bills con el mapeo de proveedores, productos y cuentas analíticas ya configurado.

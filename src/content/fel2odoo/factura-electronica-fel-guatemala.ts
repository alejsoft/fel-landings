...
Esta es exactamente la misma información que tu equipo contable necesita para registrar la factura en Odoo. La diferencia es que hoy esa información se extrae manualmente del XML o del PDF y se digita en el sistema.

Fel2Odoo elimina ese paso. Recibe los DTE directamente de la SAT en tiempo real, extrae los datos del XML y crea el Vendor Bill en Odoo automáticamente vía API. No hay descarga manual del portal SAT, no hay Excel intermedio, no hay digitación. El XML de la SAT alimenta directamente tu ERP.`,
    },
  ],
};

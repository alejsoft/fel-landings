...
Fel2GP conecta directamente con la SAT de Guatemala y registra las facturas de compra en Dynamics GP de forma automática. Los datos se extraen del XML certificado y se crean las Payables Transactions con el mapeo de Vendors, cuentas contables y distribución GL ya configurado vía eConnect.

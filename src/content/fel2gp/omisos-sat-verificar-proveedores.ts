...
Fel2GP verifica automáticamente el estado fiscal del proveedor en la SAT antes de registrar cada factura en Dynamics GP. Si el proveedor tiene omisos de bloqueo, la factura se marca para revisión en lugar de registrarse. Si está solvente, la Payables Transaction se crea automáticamente vía eConnect.

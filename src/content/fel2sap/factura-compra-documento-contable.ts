...
Fel2SAP automatiza este proceso completo. Al recibir el DTE de la SAT, el sistema clasifica la factura según reglas configuradas, asigna la cuenta contable, calcula retenciones, distribuye por centro de costo y crea la A/P Invoice en SAP Business One o S/4HANA con toda la información contable lista.

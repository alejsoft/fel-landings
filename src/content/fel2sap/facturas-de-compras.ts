...
Toda esta información está contenida en el XML certificado por la SAT. Es la misma información que tu equipo contable necesita para registrar la factura en tu sistema ERP o contable.`,
    },
    {
      ...
      body: `Cuando tu empresa recibe pocas facturas de compra al mes, el proceso manual funciona: descargar el XML del portal de la SAT, extraer los datos y registrarlos en SAP.
...
Fel2SAP es una de estas soluciones. Recibe los DTE directamente de la SAT en tiempo real, valida la información del XML y crea la A/P Invoice en SAP Business One o S/4HANA automáticamente. El mapeo de proveedores, artículos y distribución contable se configura una sola vez.

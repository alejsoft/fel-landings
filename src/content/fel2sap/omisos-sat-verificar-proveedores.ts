...
Fel2SAP verifica automáticamente el estado fiscal del proveedor en la SAT antes de registrar cada factura en SAP Business One o S/4HANA. Si el proveedor tiene omisos de bloqueo, la factura se marca para revisión en lugar de registrarse. Si está solvente, la A/P Invoice se crea automáticamente.

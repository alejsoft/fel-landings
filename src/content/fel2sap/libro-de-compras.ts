...
Fel2SAP recibe las facturas de compra directamente de la SAT en tiempo real y las registra automáticamente en SAP Business One o S/4HANA. Cada A/P Invoice se crea con todos los datos que alimentan el libro de compras: fecha, NIT del proveedor, descripción, montos, IVA y tipo de documento.
